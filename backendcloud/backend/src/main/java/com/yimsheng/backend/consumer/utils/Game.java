package com.yimsheng.backend.consumer.utils;
...
public class Game extends Thread{
    ...
    private void sendResult(){
        //broadcast result to two clients
...
;    }
    ...
    private void judge(){
        //next step of two client legit or not
